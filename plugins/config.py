...
class Config(object):
    ...
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002908124049"))
    LOGGER = logging
    OWNER_ID = int(os.environ.get("OWNER_ID", "7881009185"))
    SESSION_NAME = "UploaderXNTBot"
    UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1003170937639")

    TG_MIN_FILE_SIZE = 2194304000
    BOT_USERNAME = os.environ.get("BOT_USERNAME", "Url_downloads_bot")
    ADL_BOT_RQ = {}
